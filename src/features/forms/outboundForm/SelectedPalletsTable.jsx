...
import { setSelectedSortConfig, setSelectedFilters } from "./outboundFormSlice";
...
export const SelectedPalletsTable = ({
    data,
    selectedRows,
    setSelectedRows
}) => {

    const { selectedPalletsSortConfig, selectedPalletsFilters } = useSelector((state) => state.outboundForm);

    return (
        <FormTable
            tableOrigin="selectedPallets"
            columns={palletsColumns}
            rows={data}
            selectedRows={selectedRows}
            setSelectedRows={setSelectedRows}
            getRowId={(row) => row.pallet_id}
            sortConfig={selectedPalletsSortConfig}
            setSortConfig={setSelectedSortConfig}
            filters={selectedPalletsFilters}
